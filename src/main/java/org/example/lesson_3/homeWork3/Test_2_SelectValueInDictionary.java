...
public class Test_2_SelectValueInDictionary {
...
//        chromeOptions.addArguments("--disable-notifications");// добавляем аргумент disable-notifications - работа без всплывающих уведомлений
   ...
   //переходим на страницу
        ...
        webDriver.findElement(By.xpath("//div[@id=\"dictionary\"]//span[text()=\"do their homework\"]")).click();//находим элемент по локатору(xpath) , кликаем
